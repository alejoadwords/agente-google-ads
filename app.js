...
function agencyRender() {
  ...
  const listHeader = document.getElementById('agency-list-header');
  if (total === 0) {
  ...
  agencyClients.forEach((client, idx) => {
    ...
    const html = `
      ...
      <div>
        ...
        <div class="agency-card-business">${esc(client.business || '')}</div>
      </div>
      ...
      <div class="agency-card-agents">
        ...
        <button class="agency-agent-btn social" title="Social Media Manager" onclick="openAgentForClient('social',agencyClients.find(x=>x.id==='${client.id}'))">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11l19-9-9 19-2-8-8-2z"/></svg>
        </button>
