...
const CUENTA = 'user_prueba_mover';
...
insert into public.pipelines (id, user_id, client_id, name, is_default, position) values
  ('11111111-1111-1111-1111-111111111111','${CUENTA}', null, 'Principal', true, 0),
  ('22222222-2222-2222-2222-222222222222','${CUENTA}', null, 'Arriendo', false, 1),
  ('33333333-3333-3333-3333-333333333333','${CUENTA}', 'cli_otro', 'De otro cliente', false, 2);

insert into public.pipeline_stages (user_id, pipeline_id, key, label, position) values
  ('${CUENTA}','11111111-1111-1111-1111-111111111111','nuevo','Nuevo',0),
  ('${CUENTA}','11111111-1111-1111-1111-111111111111','contactado','Contactado',1),
  ('${CUENTA}','11111111-1111-1111-1111-111111111111','ganado','Ganado',2),
  ('${CUENTA}','22222222-2222-2222-2222-222222222222','visita','Visita al inmueble',0),
  ('${CUENTA}','22222222-2222-2222-2222-222222222222','contactado','Contactado',1),
  ('${CUENTA}','22222222-2222-2222-2222-222222222222','ganado','Ganado',2),
  ('${CUENTA}','33333333-3333-3333-3333-333333333333','nuevo','Nuevo',0);

insert into public.leads (id, user_id, client_id, name, stage, stage_position, pipeline_id, source) values
  ('aaaaaaaa-0000-0000-0000-000000000001','${CUENTA}', null, 'Comparte etapa', 'contactado', 5, '11111111-1111-1111-1111-111111111111','manual'),
  ('aaaaaaaa-0000-0000-0000-000000000002','${CUENTA}', null, 'Etapa huerfana', 'nuevo', 5, '11111111-1111-1111-1111-111111111111','manual');`);
...
const ARRIENDO  = '22222222-2222-2222-2222-222222222222';
const AJENO     = '33333333-3333-3333-3333-333333333333';
const COMPARTE  = 'aaaaaaaa-0000-0000-0000-000000000001';  // etapa «contactado», existe en los dos
const HUERFANA  = 'aaaaaaaa-0000-0000-0000-000000000002';  // etapa «nuevo», NO existe en Arriendo
