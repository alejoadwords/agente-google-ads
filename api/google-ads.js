...
async function getApiVersion(customerId, accessToken) {
  ...
  // Aquí NO se manda `login-customer-id`. Esta sonda solo busca qué versión de
  // la API existe, y eso lo dice el 404 o el UNSUPPORTED_VERSION de la URL. Un
...
Responde ÚNICAMENTE con este JSON válido sin texto extra ni markdown:
{
  ...
  "descriptions": ["Description 1 con beneficio y CTA máximo noventa caracteres en total aquí", "Description 2 igual", "Description 3"]
      ...
      await apuntaIA({ userId: _usuarioIA(req), origen: 'agente', agente: 'google-ads-copy', modelo: 'claude-sonnet-5', uso: aiData.usage });
